...
using GbWebApp.Domain.DTO.Identity;
using Microsoft.EntityFrameworkCore;
using Microsoft.AspNetCore.Identity;
using GbWebApp.Domain.Entities.Identity;
using Microsoft.AspNetCore.Identity.EntityFrameworkCore;

namespace GbWebApp.ServiceHosting.Controllers.Identity
{
    [Route(WebApiRoutes.Identity.User)]
    [ApiController]
    public class UsersController : ControllerBase
    {
        private readonly UserStore<User, Role, GbWebAppDB> _UserStore;

        public UsersController(GbWebAppDB db) { _UserStore = new UserStore<User, Role, GbWebAppDB>(db); }
        ...
        [HttpPost("Role/{role}")]
        public async Task AddToRoleAsync([FromBody] User user, string role, [FromServices] GbWebAppDB db)
        {
        ...
        public async Task RemoveFromRoleAsync([FromBody] User user, string role, [FromServices] GbWebAppDB db)
        {
        ...
        [HttpPost("AddClaims")]
        public async Task AddClaimsAsync([FromBody] AddClaimDTO ClaimInfo, [FromServices] GbWebAppDB db)
        {
        ...
        public async Task ReplaceClaimAsync([FromBody] ReplaceClaimDTO ClaimInfo, [FromServices] GbWebAppDB db)
        {
        ...
        public async Task RemoveClaimsAsync([FromBody] RemoveClaimDTO ClaimInfo, [FromServices] GbWebAppDB db)
        {
        ...
        [HttpPost("AddLogin")]
        public async Task AddLoginAsync([FromBody] AddLoginDTO login, [FromServices] GbWebAppDB db)
        {
        ...
        public async Task RemoveLoginAsync([FromBody] User user, string LoginProvider, string ProviderKey, [FromServices] GbWebAppDB db)
        {
